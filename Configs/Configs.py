...
class AConfigs(Singleton):
    def __init__(self) -> None:
        if not super().created:
            # Вы можете изменить это логическое значение на False, если хотите запретить боту автоматическое отключение.
            ...
            self.COMMANDS_FOLDER_NAME = os.getenv('COMMANDS_FOLDER_NAME', 'Cogs')
            ...
            self.PROJECT_URL = os.getenv('PROJECT_URL', 'https://github.com/TeamKOMAP/AltushkaBot')
