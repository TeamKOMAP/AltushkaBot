...
from Messages.DcMessages import AAbstractMessage, ADefaultMessage


class EmbedCommandReply(AbstractCommandReply):
    ...
    async def run(self, deleteLast: bool = True) -> None:
        ...
        if message:
            vMessage: AAbstractMessage = ADefaultMessage(message)
