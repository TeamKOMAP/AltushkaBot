...
class ProcessPlayer(Process):
        ...
        with self.__playlistLock:
            with self.__playerLock:
                ...
                if song is not None:
                    ...
                    sleepCommand = ACommands(ACommandsType.SLEEPING)
    ...
    def __commandsReceiver(self) -> None:
        ...
        while True:
            command: ACommands = self.__queueReceive.get()
    ...
    async def __ensureDiscordConnection(self, bot: AltushkaBot) -> None:
