...
from Config.Exceptions import AltError
...
class AEmbeds:
    ...
    def __willShowProject(self) -> bool:
        return (random() * 1 < self.__config.CHANCE_SHOW_PROJECT)

    def __addFooterContent(self, embed: Embed) -> Embed:
        footerText = f'\u200b 77777777777777777777: {self.__config.PROJECT_URL}'
    ...
    def SONG_INFO(self, info: dict, title: str, position='Играет сейчас:') -> Embed:
        embedvc = Embed(
            title=title,
