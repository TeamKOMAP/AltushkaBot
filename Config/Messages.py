...
class Messages(Singleton):
    def __init__(self) -> None:
        if not super().created:
            ...
            self.STARTUP_COMPLETE_MESSAGE = 'Altushka is now ordered!'
            ...
            self.LOOP_ALL_ALREADY_ON = f'{self.__emojis.LOOP_ALL} Altushka is already looping all songs'
            self.LOOP_ONE_ALREADY_ON = f'{self.__emojis.LOOP_ONE} Altushka is already looping the current song'
